...
exports.BETA_ESTIMATE_VERSION = void 0;
exports.extractOutwardCode = extractOutwardCode;
exports.calculateBetaEstimate = calculateBetaEstimate;
// ============================================================================
// CONSTANTS
// ============================================================================
...
exports.BETA_ESTIMATE_VERSION = 'beta-v1';
// ============================================================================
// HELPERS
// ============================================================================
...
function getPostcodeFactor(postcode) {
 ...
 */
function calculateBetaEstimate(input) {
    ...
    if (personalScore >= REFUND_SCORE_THRESHOLD) {
        ...
        refundRate = clamp(REFUND_RATE_MIN + rawRefundRate * REFUND_RATE_RANGE, REFUND_RATE_MIN, REFUND_RATE_MAX);
    }
...
//# sourceMappingURL=betaEstimateService.js.map